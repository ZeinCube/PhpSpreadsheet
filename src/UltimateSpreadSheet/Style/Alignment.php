...
namespace PhpOffice\UltimateSpreadSheet\Style;
...
class Alignment extends Supervisor
{
     ...
     *        [
     *            'horizontal'   => \PhpOffice\UltimateSpreadSheet\Style\Alignment::HORIZONTAL_CENTER,
     *            'vertical'     => \PhpOffice\UltimateSpreadSheet\Style\Alignment::VERTICAL_CENTER,
     *            'textRotation' => 0,
     *            'wrapText'     => TRUE
     *        ]
     * );
    ...
    {
        // Excel2007 value 255 => UltimateSpreadSheet value -165
        if ($pValue == 255) {
            $pValue = -165;
        }
