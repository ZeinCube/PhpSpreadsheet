...
/** UltimateSpreadSheet root directory */
class Html extends BaseReader
{
    ...
    /**
     * Loads UltimateSpreadSheet from DOMDocument into UltimateSpreadSheet instance.
     *
    ...
    /**
     * Map html border style to UltimateSpreadSheet border style.
     *
     * @param  string $style
     *
     * @return null|string
