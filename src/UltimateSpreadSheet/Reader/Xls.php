...
namespace PhpOffice\UltimateSpreadSheet\Reader;
...
use PhpOffice\UltimateSpreadSheet\Shared\CodePage;
...
use PhpOffice\UltimateSpreadSheet\Style\Borders;
...
class Xls extends BaseReader
{
    ...
    /**
     * Reads names of the worksheets from a file, without parsing the whole file to a UltimateSpreadSheet object.
     *
     * @param string $pFilename
     *
     * @throws Exception
    ...
    /**
     * Loads UltimateSpreadSheet from file.
     *
     * @param string $pFilename
     *
     * @throws Exception
    ...
    public function load($pFilename)
    {
        ...
        foreach ($this->sheets as $sheet) {
            ...
            // add sheet to UltimateSpreadSheet object
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    $width = \PhpOffice\UltimateSpreadSheet\Shared\Xls::getDistanceX($this->phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
                    $height = \PhpOffice\UltimateSpreadSheet\Shared\Xls::getDistanceY($this->phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);

                    // calculate offsetX and offsetY of the shape
                    $offsetX = $startOffsetX * \PhpOffice\UltimateSpreadSheet\Shared\Xls::sizeCol($this->phpSheet, $startColumn) / 1024;
                    $offsetY = $startOffsetY * \PhpOffice\UltimateSpreadSheet\Shared\Xls::sizeRow($this->phpSheet, $startRow) / 256;
        ...
        for ($i = 0; $i < $countProperties; ++$i) {
            ...
            switch ($id) {
                ...
                case 0x06:    //    Comments (Description)
                    ...
                    break;
                case 0x07:    //    Template
                    //    Not supported by UltimateSpreadSheet
                    break;
...
//                                                    ->setAuthor($author)
    ...
    private function readStyle()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            // user-defined; not supported by UltimateSpreadSheet
        }
    }
    ...
    private function readPane()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            // unfrozen panes; split windows; not supported by UltimateSpreadSheet core
        }
    }
