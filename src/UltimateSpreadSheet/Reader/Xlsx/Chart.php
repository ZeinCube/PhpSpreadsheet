...
namespace PhpOffice\UltimateSpreadSheet\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \PhpOffice\UltimateSpreadSheet\Chart\Chart
     */
    public static function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \PhpOffice\UltimateSpreadSheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
