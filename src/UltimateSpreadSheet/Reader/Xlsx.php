...
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\AutoFilter;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\Chart;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\ColumnAndRowAttributes;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\ConditionalStyles;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\DataValidations;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\Hyperlinks;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\PageSetup;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\Properties as PropertyReader;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\SheetViewOptions;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\SheetViews;
use PhpOffice\UltimateSpreadSheet\Reader\Xlsx\Styles;
...
use PhpOffice\UltimateSpreadSheet\Shared\Drawing;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if ($xmlDrawingChildren->oneCellAnchor) {
                                            foreach ($xmlDrawingChildren->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill) {
                                                    ...
                                                    $objDrawing = new \PhpOffice\UltimateSpreadSheet\Worksheet\Drawing();
    ...
    private static function readStyle(Style $docStyle, $style)
    {
        ...
        if (isset($style->font)) {
            ...
            if (isset($style->font->u) && !isset($style->font->u['val'])) {
                $docStyle->getFont()->setUnderline(\PhpOffice\UltimateSpreadSheet\Style\Font::UNDERLINE_SINGLE);
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u) && !isset($run->rPr->u['val'])) {
                            $objText->getFont()->setUnderline(\PhpOffice\UltimateSpreadSheet\Style\Font::UNDERLINE_SINGLE);
    ...
    /**
     * @param \PhpOffice\UltimateSpreadSheet\Worksheet\Drawing $objDrawing
