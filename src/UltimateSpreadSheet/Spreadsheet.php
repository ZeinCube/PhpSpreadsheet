...
class Spreadsheet
{
    ...
    /**
     * Create a new UltimateSpreadSheet with one Worksheet.
     */
    ...
    /**
     * Disconnect all worksheets from this UltimateSpreadSheet workbook object,
     * typically so that the UltimateSpreadSheet object can be unset.
     */
