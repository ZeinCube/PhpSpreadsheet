...
namespace PhpOffice\UltimateSpreadSheet\Shared\OLE\PPS;
...
use PhpOffice\UltimateSpreadSheet\Shared\OLE\PPS;
...
class Root extends PPS
{
    ...
    {
        $this->tempDirectory = \PhpOffice\UltimateSpreadSheet\Shared\File::sysGetTempDir();
    ...
    /**
     * Saving big data (PPS's with data bigger than \PhpOffice\UltimateSpreadSheet\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param int $iStBlk
    ...
    /**
     * get small data (PPS's with data smaller than \PhpOffice\UltimateSpreadSheet\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param array &$raList Reference to array of PPS's
     *
     * @return string
