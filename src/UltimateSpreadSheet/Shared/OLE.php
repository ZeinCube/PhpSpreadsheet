...
use PhpOffice\UltimateSpreadSheet\Reader\Exception as ReaderException;
use PhpOffice\UltimateSpreadSheet\Shared\OLE\ChainedBlockStream;
...
class OLE
{
     ...
     * use \PhpOffice\UltimateSpreadSheet\Shared\OLE\PPS\File::getStream().
     *
