...
namespace PhpOffice\UltimateSpreadSheet\Shared;
...
class Font
{
     ...
     *
     * @param \PhpOffice\UltimateSpreadSheet\Style\Font $font Font object
     * @param RichText|string $cellText Text to calculate width
     * @param int $rotation Rotation angle
     * @param null|\PhpOffice\UltimateSpreadSheet\Style\Font $defaultFont Font object
     *
     * @return int Column width
     */
    public static function calculateColumnWidth(\PhpOffice\UltimateSpreadSheet\Style\Font $font, $cellText = '', $rotation = 0, \PhpOffice\UltimateSpreadSheet\Style\Font $defaultFont = null)
    {
     ...
     *
     * @param string $text
     * @param \PhpOffice\UltimateSpreadSheet\Style\Font
     * @param int $rotation
     *
     * @return int
     ...
     *
     */
    public static function getTextWidthPixelsExact($text, \PhpOffice\UltimateSpreadSheet\Style\Font $font, $rotation = 0)
    {
     ...
     * @param \PhpOffice\UltimateSpreadSheet\Style\Font $font
     * @param int $rotation
     *
     * @return int Text width in pixels (no padding added)
     */
    public static function getTextWidthPixelsApprox($columnText, \PhpOffice\UltimateSpreadSheet\Style\Font $font, $rotation = 0)
    {
     ...
     *
     * @param \PhpOffice\UltimateSpreadSheet\Style\Font $font The workbooks default font
     * @param bool $pPixels true = return column width in pixels, false = return in OOXML units
     *
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(\PhpOffice\UltimateSpreadSheet\Style\Font $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(\PhpOffice\UltimateSpreadSheet\Style\Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
