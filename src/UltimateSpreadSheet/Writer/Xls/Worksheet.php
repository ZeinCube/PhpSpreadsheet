...
namespace PhpOffice\UltimateSpreadSheet\Writer\Xls;
...
use PhpOffice\UltimateSpreadSheet\Exception as PhpSpreadsheetException;
use PhpOffice\UltimateSpreadSheet\RichText\RichText;
use PhpOffice\UltimateSpreadSheet\RichText\Run;
use PhpOffice\UltimateSpreadSheet\Shared\StringHelper;
use PhpOffice\UltimateSpreadSheet\Shared\Xls;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \PhpOffice\UltimateSpreadSheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var \PhpOffice\UltimateSpreadSheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $phpSheet)
    {
...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
     ...
     *
     * @see \PhpOffice\UltimateSpreadSheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close()
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \PhpOffice\UltimateSpreadSheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
    ...
    private function writeWindow2()
    {
        ...
        // no support in UltimateSpreadSheet for selected sheet, therefore sheet is only selected if it is the active sheet
    ...
    private function writeBreaks()
    {
        ...
        foreach ($this->phpSheet->getBreaks() as $cell => $breakType) {
            ...
            switch ($breakType) {
                case \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet::BREAK_COLUMN:
                    // Add to list of vertical breaks
                    $vbreaks[] = Coordinate::columnIndexFromString($coordinates[0]) - 1;

                    break;
                case \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet::BREAK_ROW:
                    // Add to list of horizontal breaks
                    $hbreaks[] = $coordinates[1];

                    break;
                case \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet::BREAK_NONE:
                default:
                    // Nothing to do
                    break;
            }
     ...
     * Get Escher object.
     *
     * @return \PhpOffice\UltimateSpreadSheet\Shared\Escher
     */
     ...
     * Set Escher object.
     *
     * @param \PhpOffice\UltimateSpreadSheet\Shared\Escher $pValue
     */
    public function setEscher(\PhpOffice\UltimateSpreadSheet\Shared\Escher $pValue = null)
    {
        $this->escher = $pValue;
    }
    ...
    private function writeCFRule(Conditional $conditional)
    {
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \PhpOffice\UltimateSpreadSheet\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;

                    break;
                case \PhpOffice\UltimateSpreadSheet\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;

                    break;
                case \PhpOffice\UltimateSpreadSheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;

                    break;
                case \PhpOffice\UltimateSpreadSheet\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;

                    break;
                case \PhpOffice\UltimateSpreadSheet\Style\Font::UNDERLINE_SINGLEACCOUNTING:
