...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \PhpOffice\UltimateSpreadSheet\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
     ...
     */
    public function addFont(\PhpOffice\UltimateSpreadSheet\Style\Font $font)
    {
    ...
    private function writeWindow1()
    {
        ...
        // not supported by UltimateSpreadSheet, so there is only one selected sheet, the active
        $ctabsel = 1; // Number of workbook tabs selected

        $wTabRatio = 0x0258; // Tab to scrollbar ratio

        // not supported by UltimateSpreadSheet, set to 0
    ...
    private function writeBoundSheet($sheet, $offset)
    {
        ...
        switch ($sheet->getSheetState()) {
            case \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;

                break;
            case \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;

                break;
            case \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;
