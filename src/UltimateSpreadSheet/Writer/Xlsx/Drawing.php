...
use PhpOffice\UltimateSpreadSheet\Worksheet\BaseDrawing;
use PhpOffice\UltimateSpreadSheet\Worksheet\HeaderFooterDrawing;
use PhpOffice\UltimateSpreadSheet\Writer\Exception as WriterException;
...
class Drawing extends WriterPart
{
     ...
     *
     * @param \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet
     ...
     *
     */
    public function writeDrawings(\PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @param \PhpOffice\UltimateSpreadSheet\Chart\Chart $pChart
     * @param int $pRelationId
     */
    public function writeChart(XMLWriter $objWriter, \PhpOffice\UltimateSpreadSheet\Chart\Chart $pChart, $pRelationId = -1)
    {
        ...
        $objWriter->writeElement('xdr:colOff', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($tl['xOffset']));
        $objWriter->writeElement('xdr:row', $tl['colRow'][1] - 1);
        $objWriter->writeElement('xdr:rowOff', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($tl['yOffset']));
        $objWriter->endElement();
        $objWriter->startElement('xdr:to');
        $objWriter->writeElement('xdr:col', Coordinate::columnIndexFromString($br['colRow'][0]) - 1);
        $objWriter->writeElement('xdr:colOff', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($br['xOffset']));
        $objWriter->writeElement('xdr:row', $br['colRow'][1] - 1);
        $objWriter->writeElement('xdr:rowOff', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($br['yOffset']));
        $objWriter->endElement();
    ...
    public function writeDrawing(XMLWriter $objWriter, BaseDrawing $pDrawing, $pRelationId = -1, $hlinkClickId = null)
    {
        if ($pRelationId >= 0) {
            ...
            $objWriter->writeElement('xdr:colOff', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($pDrawing->getOffsetX()));
            $objWriter->writeElement('xdr:row', $aCoordinates[1] - 1);
            $objWriter->writeElement('xdr:rowOff', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($pDrawing->getOffsetY()));
            $objWriter->endElement();

            // xdr:ext
            $objWriter->startElement('xdr:ext');
            $objWriter->writeAttribute('cx', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($pDrawing->getWidth()));
            $objWriter->writeAttribute('cy', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($pDrawing->getHeight()));
            $objWriter->endElement();
            ...
            $objWriter->writeAttribute('rot', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::degreesToAngle($pDrawing->getRotation()));
            $objWriter->endElement();
            ...
            if ($pDrawing->getShadow()->getVisible()) {
                ...
                $objWriter->writeAttribute('blurRad', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($pDrawing->getShadow()->getBlurRadius()));
                $objWriter->writeAttribute('dist', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::pixelsToEMU($pDrawing->getShadow()->getDistance()));
                $objWriter->writeAttribute('dir', \PhpOffice\UltimateSpreadSheet\Shared\Drawing::degreesToAngle($pDrawing->getShadow()->getDirection()));
     ...
     *
     */
    public function writeVMLHeaderFooterImages(\PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     *
     * @return \PhpOffice\UltimateSpreadSheet\Worksheet\Drawing[] All drawings in UltimateSpreadSheet
     */
    public function allDrawings(Spreadsheet $spreadsheet)
    {
        ...
        // Loop through UltimateSpreadSheet
