...
class Rels extends WriterPart
{
     ...
     *
     */
    public function writeWorksheetRelationships(\PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet, $pWorksheetId = 1, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
    ...
    private function writeUnparsedRelationship(\PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet, XMLWriter $objWriter, $relationship, $type)
    {
        $unparsedLoadedData = $pWorksheet->getParent()->getUnparsedLoadedData();
     ...
     *
     */
    public function writeDrawingRelationships(\PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet, &$chartRef, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
        ...
        while ($iterator->valid()) {
            if ($iterator->current() instanceof \PhpOffice\UltimateSpreadSheet\Worksheet\Drawing
                || $iterator->current() instanceof MemoryDrawing) {
                // Write relationship for image drawing
                /** @var \PhpOffice\UltimateSpreadSheet\Worksheet\Drawing $drawing */
     ...
     *
     */
    public function writeHeaderFooterDrawingRelationships(\PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
    ...
    /**
     * @param $objWriter
     * @param \PhpOffice\UltimateSpreadSheet\Worksheet\Drawing $drawing
     * @param $i
     *
     * @return int
     *@throws WriterException
