...
use PhpOffice\UltimateSpreadSheet\Comment;
...
class Comments extends WriterPart
{
     ...
     *
     */
    public function writeComments(\PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
     ...
     *
     */
    public function writeVMLComments(\PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
