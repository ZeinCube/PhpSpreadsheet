...
class Style extends WriterPart
{
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \PhpOffice\UltimateSpreadSheet\Style\Style $pStyle Style
     * @param Spreadsheet $spreadsheet Workbook
     *
     * @throws \PhpOffice\UltimateSpreadSheet\Writer\Exception
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \PhpOffice\UltimateSpreadSheet\Style\Style $pStyle, Spreadsheet $spreadsheet)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @param \PhpOffice\UltimateSpreadSheet\Style\Style $pStyle Style
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \PhpOffice\UltimateSpreadSheet\Style\Style $pStyle)
    {
        // dxf
     ...
     * @param Spreadsheet $spreadsheet
     *
     * @return \PhpOffice\UltimateSpreadSheet\Style\Style[] All styles in UltimateSpreadSheet
     */
     ...
     * @param Spreadsheet $spreadsheet
     *
     * @return Conditional[] All conditional styles in UltimateSpreadSheet
     */
     ...
     * @param Spreadsheet $spreadsheet
     *
     * @return Fill[] All fills in UltimateSpreadSheet
     */
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \PhpOffice\UltimateSpreadSheet\Style\Style $style */
     ...
     * @param Spreadsheet $spreadsheet
     *
     * @return Font[] All fonts in UltimateSpreadSheet
     */
     ...
     * @param Spreadsheet $spreadsheet
     *
     * @return Borders[] All borders in UltimateSpreadSheet
     */
     ...
     * @param Spreadsheet $spreadsheet
     *
     * @return NumberFormat[] All number formats in UltimateSpreadSheet
     */
