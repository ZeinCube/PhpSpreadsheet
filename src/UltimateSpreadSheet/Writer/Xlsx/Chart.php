...
class Chart extends WriterPart
{
     ...
     *
     */
    public function writeChart(\PhpOffice\UltimateSpreadSheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pSheet
     ...
     * @throws WriterException
     */
    private function writePlotArea(XMLWriter $objWriter, \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, Title $xAxisLabel = null, Title $yAxisLabel = null, Axis $xAxis = null, Axis $yAxis = null, GridLines $majorGridlines = null, GridLines $minorGridlines = null)
    {
        if ($plotArea === null) {
            return;
        }
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \PhpOffice\UltimateSpreadSheet\Chart\Layout $chartLayout Chart layout
     */
