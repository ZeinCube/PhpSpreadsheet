...
use PhpOffice\UltimateSpreadSheet\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
    ...
    public function generateHTMLHeader($pIncludeStyles = false)
    {
        ...
        $html .= '      <meta name="generator" content="UltimateSpreadSheet, https://github.com/PHPOffice/UltimateSpreadSheet">' . PHP_EOL;
     ...
     *
     * @param Worksheet $pSheet \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet
    ...
    /**
     * Create CSS style (\PhpOffice\UltimateSpreadSheet\Style\Alignment).
     *
     * @param Alignment $pStyle \PhpOffice\UltimateSpreadSheet\Style\Alignment
     *
     * @return array
     */
    ...
    /**
     * Create CSS style (\PhpOffice\UltimateSpreadSheet\Style\Font).
     *
     * @param Font $pStyle
     *
     * @return array
        ...
        foreach ($pValues as $cellAddress) {
            ...
            if ($writeCell) {
                ...
                if (!$this->useInlineCss) {
                    ...
                    //** Necessary redundant code for the sake of \PhpOffice\UltimateSpreadSheet\Writer\Pdf **
