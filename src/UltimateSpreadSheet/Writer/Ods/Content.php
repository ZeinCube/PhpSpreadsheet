...
use PhpOffice\UltimateSpreadSheet\Writer\Exception;
use PhpOffice\UltimateSpreadSheet\Writer\Ods;
use PhpOffice\UltimateSpreadSheet\Writer\Ods\Cell\Comment;
...
class Content extends WriterPart
{
    ...
    private function writeCells(XMLWriter $objWriter, Row $row)
    {
        ...
        while ($cells->valid()) {
            /** @var \PhpOffice\UltimateSpreadSheet\Cell\Cell $cell */
            $cell = $cells->current();
