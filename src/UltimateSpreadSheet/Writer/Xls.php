...
use PhpOffice\UltimateSpreadSheet\Shared\Drawing as SharedDrawing;
use PhpOffice\UltimateSpreadSheet\Shared\Escher;
use PhpOffice\UltimateSpreadSheet\Shared\Escher\DgContainer;
use PhpOffice\UltimateSpreadSheet\Shared\Escher\DgContainer\SpgrContainer;
use PhpOffice\UltimateSpreadSheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use PhpOffice\UltimateSpreadSheet\Shared\Escher\DggContainer;
use PhpOffice\UltimateSpreadSheet\Shared\Escher\DggContainer\BstoreContainer;
use PhpOffice\UltimateSpreadSheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use PhpOffice\UltimateSpreadSheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use PhpOffice\UltimateSpreadSheet\Shared\OLE;
use PhpOffice\UltimateSpreadSheet\Shared\OLE\PPS\File;
use PhpOffice\UltimateSpreadSheet\Shared\OLE\PPS\Root;
...
class Xls extends BaseWriter
{
    ...
    /**
     * @var \PhpOffice\UltimateSpreadSheet\Writer\Xls\Workbook
     */
    private $writerWorkbook;

    /**
     * @var \PhpOffice\UltimateSpreadSheet\Writer\Xls\Worksheet[]
     */
    ...
    private function buildWorksheetEschers()
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \PhpOffice\UltimateSpreadSheet\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
