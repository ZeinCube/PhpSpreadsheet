...
use PhpOffice\UltimateSpreadSheet\Chart\Renderer\IRenderer;
use PhpOffice\UltimateSpreadSheet\Collection\Memory;
...
class Settings
{
     ...
     * eg: PhpOffice\UltimateSpreadSheet\Chart\Renderer\JpGraph.
     *
     * @var string
     */
    ...
    /**
     * Identify to UltimateSpreadSheet the external library to use for rendering charts.
     *
    ...
    /**
     * Return the Chart Rendering Library that UltimateSpreadSheet is currently configured to use.
     *
