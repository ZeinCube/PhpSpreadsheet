...
class AutoFilterTest extends TestCase
{
    ...
    public function testSetColumnWithString()
    {
        ...
        $result = $this->testAutoFilterObject->getColumns();
        //  Result should be an array of \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet\AutoFilter\Column
    ...
    public function testGetColumn()
    {
        ...
        //    get a \PhpOffice\UltimateSpreadSheet\Worksheet\Worksheet\AutoFilter\Column object returned
        foreach ($columnIndexes as $columnIndex) {
